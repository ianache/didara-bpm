...
create table ORGANIZATIONALENTITY (
    ...
    IDENTITYREF VARCHAR(60) NOT NULL,
    IDENTITYTYPE INT NOT NULL
);
alter table ORGANIZATIONALENTITY
    add constraint ORGANIZATIONALENTITY_PK1
    primary key (PARTICIPANT_ID,IDENTITYREF);
alter table ORGANIZATIONALENTITY
    add constraint ORGANIZATIONALENTITY_FK1
...
create table TASKDEFINITION (
    ...
    SKIPABLE CHAR(1) NULL,
    PRIORITY INT NOT NULL,
    EXPEXPRESSION VARCHAR(60) NULL,
    PARTICIPANT_ID VARCHAR(36) NOT NULL
);
